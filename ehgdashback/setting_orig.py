...
SECRET_KEY = "django-insecure-)3uz!w%pc(##b8c2+svyp$_2wa42as6v4!3j+l-5c=n&!z0^@e"
...
DATABASES = {
    # 'default': {
    #     'ENGINE': 'django.db.backends.sqlite3',  # Aqui usamos SQLite
    #     'NAME': BASE_DIR / 'db.sqlite3',  # O arquivo do banco será armazenado aqui
    # }
    'default': {
